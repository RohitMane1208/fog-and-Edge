...
TOPIC = "solar/raw/voltage"

mqtt_connection = mqtt_connection_builder.mtls_from_path(
    endpoint=ENDPOINT, cert_filepath=CERT, pri_key_filepath=KEY, ca_filepath=ROOT, client_id="voltage_sensor_node"
)

mqtt_connection.connect().result()
print("Voltage Sensor Active...")
...
while True:
    ...
    print(f"Sent Voltage/Current: {data}")
    time.sleep(5)